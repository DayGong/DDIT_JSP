...
<div class="container">
	...
	<div class="row" align="center">
		...
		<div class="col-md-4">
			<img src="/WebMarket/images/${productVO.filename}" style="width:100%;"/>
			...
			요청방식 : get
			-->
				<a href="/WebMarket/product.jsp?productId=${productVO.productId}" 
	...
	<div class="form-group row">
		<div class="col-sm-offset-2 col-sm-10">
			<a href="/WebMarket/addProduct.jsp" class="btn btn-primary">등록</a>
		</div>
	</div>
</div>
